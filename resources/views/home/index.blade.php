        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="mb-4">eLearning’s mission is to create new possibilities for people and organizations everywhere by connecting them to the knowledge and skills they need to succeed in a changing world.</p>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-4 justify-content-center">
                ...
                @foreach($courselist1 as $rs)
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="course-item bg-light">
                        <a href="{{route('course',['id'=>$rs->id])}}" class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</a>

                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="{{Storage::url($rs->image)}}" style="width:600px; height:270px">
                            <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                                <a href="{{route('course',['id'=>$rs->id])}}" class="flex-shrink-0 btn btn-sm btn-primary px-3" style="border-radius: 0 30px 30px 0;">Join Now</a>
                            </div>
                        </div>
